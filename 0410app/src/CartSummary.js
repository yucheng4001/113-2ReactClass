                                    ...
                                    <td style={{ padding: '8px' }}>
                                        <div style={{ display: 'flex', alignItems: 'center' }}>
                                            ...
                                            <div>
                                                ...
                                                <p style={{ margin: '0', fontSize: '12px', color: '#666' }}>評分：{item.rating || 'N/A'}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td style={{ textAlign: 'center', padding: '8px' }}>{item.quantity}</td>
                                    <td style={{ textAlign: 'center', padding: '8px' }}>${(item.price || 0).toLocaleString()}</td>
                                    <td style={{ textAlign: 'center', padding: '8px', fontWeight: 'bold' }}>${((item.price || 0) * item.quantity).toLocaleString()}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
